...
#define GPS_TAU1201_RX       (UART2_TX_P11)                                    // GPS RX引脚连接到单片机此
#define GPS_TAU1201_TX       (UART2_RX_P10)                                    // GPS TX串口引脚
#define GPS_TAU1201_TIMER_N  (TIM_2)  				
